                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" cols="30" rows="8" class="form-control">{{$blog->description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <img src="{{ asset('uploads/blogs/'.$blog->image) }}" alt="" width="150" id="one">
                                    </div>
                                </div>
