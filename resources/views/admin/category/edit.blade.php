...
@section('title') Edit Category {{ $category->title }} - {{ config('app.name', 'Laravel') }} @endsection
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" cols="30" rows="8" class="form-control">
