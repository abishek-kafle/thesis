        ...
        <div class="page-header">
            <div class="row">
                ...
                <div class="col-auto float-right ml-auto">
                    <a href="{{ route('notice.index') }}" class="btn add-btn" ><i class="fa fa-eye"></i> View All Notices</a>
                </div>
            </div>
        </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <textarea name="description" id="description" cols="30" rows="8" class="form-control">{{$notice->description}}</textarea>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="image">Previous File Name</label>
                                        <p>{{$notice->image}}</p>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <div class="form-check" data-children-count="1">
                                            <input class="form-check-input" type="checkbox" value="1" name="status" id="status" @if ($notice->status == 1) checked @endif>
